    ...
    <nav className="bg-blue-500 p-4">
      ...
      {isMenuOpen && (
        <div className="md:hidden mt-4">
          <a href="#home" activeClassname="active-page" className="block text-white my-2">Home</a>
          <a href="#home" activeClassname="active-page" className="block text-white my-2">test</a>
